...
* [pydapper](https://pydapper.readthedocs.io/en/latest/) - A pure python micro ORM inspired by [dapper](https://dapper-tutorial.net) supporting drivers for multiple databases.
